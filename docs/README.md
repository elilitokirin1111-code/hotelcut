...
| `ai-director/creative-workflow.md` | AI creative, scripts and revisions      | AI Director 1    |
| `用户操作说明.md`                  | End-user operation guide (Chinese)      | M7+              |
| `竞品分析.md`                      | JianYing comparison and differentiation | Cross-cutting    |

Documents state their implementation status explicitly; M0 through M6 are implemented, M7 is in
progress, and AI Director Phases 0-1 are implemented behind feature flags.
